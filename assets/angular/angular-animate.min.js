            ...
            "$$asyncCallback", "$rootScope", "$document", function (x, G, aa, L, F, I, Q) {
                ...
                function M(a, b, c) {
                    function d(a, b) {
                        ...
                        if (c || d)return"leave" == b && (d = c, c = null), u.push({event: b, fn: c}), p.push({event: b, fn: d}), !0
                    }
                    ...
                    if (e) {
                        ...
                        if (T(y)) {
                            ...
                            return{node: e, event: b, className: c, isClassBased: q, isSetClassOperation: h, before: function (a) {
                                v = a;
                                f(p, z, function () {
                                    v = r;
                                    a()
            ...
            "$$animateReflow", function (h, q, B, L) {
                ...
                function R(a, k) {
                    ...
                    if (!b) {
                        ...
                        b = {total: 0, transitionPropertyStyle: g, transitionDurationStyle: t, transitionDelayStyle: l, transitionDelay: d, transitionDuration: c, animationDelayStyle: $, animationDelay: f, animationDuration: e};
                        k && (N[k] = b)
                    }
                    return b
                }
